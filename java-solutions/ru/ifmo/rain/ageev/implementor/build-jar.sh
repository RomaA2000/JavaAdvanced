...
javac --module-path ${req} ${src}/module-info.java  ${src}/${mod_path}/JarImplementor.java ${src}/${mod_path}/Implementor.java ${src}/${mod_path}/ImplementorDirectoryManager.java  ${src}/${mod_path}/DirectoryCleaner.java  ${src}/${mod_path}/MethodHasher.java ${src}/${mod_path}/ArgumentNumberMaker.java -d ${out}
cd ${out}
